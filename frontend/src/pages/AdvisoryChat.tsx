...
const AdvisoryChat = () => {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      text: "Hello! I'm your AI farming assistant. Ask me about cultivation, fertilizers, diseases, water needs, or market prices.",
      sender: 'bot',
      timestamp: new Date(),
      language: 'en'
    }
  ...
  const responses: any = {
    en: {
      wheat: {
        ...
        diseases: "Wheat Diseases:\n• Rust → Propiconazole\n• Powdery Mildew → Sulphur\n• Spot Blotch → Carbendazim",
      ...
      rice: {
        ...
        diseases: "Rice Diseases:\n• Blast → Carbendazim\n• Brown spot → Mancozeb\n• Sheath blight → Tricyclazole",
        water: "Rice requires 1000–1500 mm of water per season.",
        market: "Market price of Rice: ₹3000–3500 per quintal (varies by variety)"
      },
      general: "Ask me about wheat, rice, tomato, maize, sugarcane, chili, soybean cultivation, fertilizers, diseases, irrigation, or market price."
    },
    hi: {
      wheat: {
        ...
        diseases: "गेहूँ की बीमारियाँ:\n• रस्ट → प्रोपीकोनाज़ोल\n• पाउडरी मिल्ड्यू → सल्फर\n• स्पॉट ब्लॉच → कार्बेंडाजिम",
    ...
    te: {
      wheat: {
        ...
        diseases: "గోధుమ రోగాలు:\n• రస్ట్ → ప్రొపికోనాజోల్\n• పౌడరీ మిల్డ్యూ → సల్ఫర్\n• స్పాట్ బ్లాచ్ → కార్బెండాజిమ్",
    ...
    ta: {
      wheat: {
        ...
        diseases: "கோதுமை நோய்கள்:\n• ரஸ்ட் → ப்ரொபிகோனாசோல்\n• பவுடரி மில்டியூ → சல்பர்\n• ஸ்பாட் பிளாட்ச் → கார்பெண்டாசிம்",
  ...
  const getFarmingResponse = (query: string, language: string) => {
    ...
    for (let crop of crops) {
      if (lowerQuery.includes(crop)) {
        ...
        if (lowerQuery.includes('disease') || lowerQuery.includes('pest')) return langResponses[crop].diseases;
        ...
        <Card className="h-[650px] flex flex-col">
          ...
          <CardContent className="flex-1 flex flex-col overflow-hidden">
            ...
            <div className="flex gap-2">
              <Input value={inputText} onChange={e => setInputText(e.target.value)} placeholder="Ask about crop, fertilizer, diseases, water, market..." />
